...
headerHtml = `<div style="padding-right: 20em; text-align: right; width: 100%;">
<div style="font-size: 10px;"><span>${title}<span></div>
<div style="font-size: 8px; font-style: italic;"><span>IES Serpis - 2DAM DIN (2023-24)<span></div>
</div>`;
...
(async () => {
    ...
    await page.evaluate(() => {
        ...
        let path = `/din2023/${window.location.pathname}`;
        base.href = `${origin}${path}`;
